...
export interface ApiImportImport extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Speed: Attribute.Integer & Attribute.Required;
    Handling: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<{
        max: 5;
      }>;
    ...
    Category: Attribute.Enumeration<
      ['Standard', 'Premium', 'Exclusive', 'Limited', 'Exquisite']
    > &
      Attribute.Required;
    Unmarketable: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
